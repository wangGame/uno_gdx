...
public class Uno {
    ...
    /**
     * Direction value (clockwise).  方向 顺
     */
     ...
     */
    Image easyImage, easyImage_d;

    /**
     * Difficulty button image resources (HARD).
     */
    Image hardImage, hardImage_d;

    /**
     * 2vs2 button image resources.
     */
    Image light2vs2, dark2vs2;
     ...
     */
    Image[] blk_r, blk_b, blk_g, blk_y, blk_w;
     ...
     * this value will be updated autoImageically.
     */
    long legality;
    ...
    Uno() throws IOException {
        ...
        loaded = 0;
        total = 127;
        NLog.i(TAG, "Loading... (0%)");

        // Load background image resources
        bgWelcome = new Image(Asset.getAsset().getTexture("bg_welcome.png"));
        bgCounter = new Image(Asset.getAsset().getTexture("bg_counter.png"));
        bgClockwise = new Image(Asset.getAsset().getTexture("bg_clockwise.png"));
...
//        Imgproc.cvtColor(bgClockwise, bgClockwise, Imgproc.COLOR_BGR2RGB);
        loaded += 3;
        NLog.i(TAG, "Loading... (" + 100 * loaded / total + "%)");

        // Load card back image resource
        backImage = new Image(Asset.getAsset().getTexture("back.png")));
        ++loaded;
        NLog.i(TAG, "Loading... (" + 100 * loaded / total + "%)");

        // Load difficulty image resources
        easyImage = new Image(Asset.getAsset().getTexture("lv_easy.png"));
        hardImage = new Image(Asset.getAsset().getTexture("lv_hard.png"));
        easyImage_d = new Image(Asset.getAsset().getTexture("lv_easy_dark.png"));
        hardImage_d = new Image(Asset.getAsset().getTexture("lv_hard_dark.png"));
        loaded += 4;
        NLog.i(TAG, "Loading... (" + 100 * loaded / total + "%)");
        // Load 2vs2 image resources
        dark2vs2 =  new Image(Asset.getAsset().getTexture("dark_2vs2.png"));
        light2vs2 = new Image(Asset.getAsset().getTexture("front_2vs2.png"));
        loaded += 2;
        NLog.i(TAG, "Loading... (" + 100 * loaded / total + "%)");

        // Load cards' front image resources
        br = new Image[]{
                new Image(Asset.getAsset().getTexture("front_r0")),
                new Image(Asset.getAsset().getTexture("front_r1")),
                new Image(Asset.getAsset().getTexture("front_r2")),
                new Image(Asset.getAsset().getTexture("front_r3")),
                new Image(Asset.getAsset().getTexture("front_r4")),
                new Image(Asset.getAsset().getTexture("front_r5")),
                new Image(Asset.getAsset().getTexture("front_r6")),
                new Image(Asset.getAsset().getTexture("front_r7")),
                new Image(Asset.getAsset().getTexture("front_r8")),
                new Image(Asset.getAsset().getTexture("front_r9")),
                new Image(Asset.getAsset().getTexture("front_rd2")),
                new Image(Asset.getAsset().getTexture("front_rr")),
                new Image(Asset.getAsset().getTexture("front_rs")),
                new Image(Asset.getAsset().getTexture("front_b0")),
                 new Image(Asset.getAsset().getTexture("front_b1")),
                 new Image(Asset.getAsset().getTexture("front_b2")),
                 new Image(Asset.getAsset().getTexture("front_b3")),
                 new Image(Asset.getAsset().getTexture("front_b4")),
                 new Image(Asset.getAsset().getTexture("front_b5")),
                 new Image(Asset.getAsset().getTexture("front_b6")),
                 new Image(Asset.getAsset().getTexture("front_b7")),
                 new Image(Asset.getAsset().getTexture("front_b8")),
                 new Image(Asset.getAsset().getTexture("front_b9")),
                 new Image(Asset.getAsset().getTexture("front_bd"2)),
                 new Image(Asset.getAsset().getTexture("front_br")),
                 new Image(Asset.getAsset().getTexture("front_bs")),
                 new Image(Asset.getAsset().getTexture("front_g0")),
                 new Image(Asset.getAsset().getTexture("front_g1")),
                 new Image(Asset.getAsset().getTexture("front_g2")),
                 new Image(Asset.getAsset().getTexture("front_g3")),
                 new Image(Asset.getAsset().getTexture("front_g4")),
                 new Image(Asset.getAsset().getTexture("front_g5")),
                 new Image(Asset.getAsset().getTexture("front_g6")),
                 new Image(Asset.getAsset().getTexture("front_g7")),
                 new Image(Asset.getAsset().getTexture("front_g8")),
                 new Image(Asset.getAsset().getTexture("front_g9")),
                 new Image(Asset.getAsset().getTexture("front_gd2")),
                 new Image(Asset.getAsset().getTexture("front_gr")),
                 new Image(Asset.getAsset().getTexture("front_gs")),
                 new Image(Asset.getAsset().getTexture("front_y0")),
                 new Image(Asset.getAsset().getTexture("front_y1")),
                 new Image(Asset.getAsset().getTexture("front_y2")),
                 new Image(Asset.getAsset().getTexture("front_y3")),
                 new Image(Asset.getAsset().getTexture("front_y4")),
                 new Image(Asset.getAsset().getTexture("front_y5")),
                 new Image(Asset.getAsset().getTexture("front_y6")),
                 new Image(Asset.getAsset().getTexture("front_y7")),
                 new Image(Asset.getAsset().getTexture("front_y8")),
                 new Image(Asset.getAsset().getTexture("front_y9")),
                 new Image(Asset.getAsset().getTexture("front_yd2")),
                 new Image(Asset.getAsset().getTexture("front_yr")),
                 new Image(Asset.getAsset().getTexture("front_ys")),
                 new Image(Asset.getAsset().getTexture("front_kw")),
                 new Image(Asset.getAsset().getTexture("front_kw"4))
        }; // br = new Image[]{}
        dk = new Image[]{
        ...
        blk_r = new Image[]{
                new Image(48, 17, CvType.CV_8UC3, rgb_red),    // for ASCII
                new Image(48, 33, CvType.CV_8UC3, rgb_red)     // for CJK
        }; // blk_r = new Image[]{}
        blk_b = new Image[]{
                new Image(48, 17, CvType.CV_8UC3, rgb_blue),   // for ASCII
                new Image(48, 33, CvType.CV_8UC3, rgb_blue)    // for CJK
        }; // blk_b = new Image[]{}
        blk_g = new Image[]{
                new Image(48, 17, CvType.CV_8UC3, rgb_green),  // for ASCII
                new Image(48, 33, CvType.CV_8UC3, rgb_green)   // for CJK
        }; // blk_g = new Image[]{}
        blk_w = new Image[]{
                new Image(48, 17, CvType.CV_8UC3, rgb_white),  // for ASCII
                new Image(48, 33, CvType.CV_8UC3, rgb_white)   // for CJK
        }; // blk_w = new Image[]{}
        blk_y = new Image[]{
                new Image(48, 17, CvType.CV_8UC3, rgb_yellow), // for ASCII
                new Image(48, 33, CvType.CV_8UC3, rgb_yellow)  // for CJK
        }; // blk_y = new Image[]{}
     ...
     */
    public Image getLevelImage(int level, boolean hiLight) {
     ...
     */
    @Deprecated
    public int getForImageTextWidth(String text) {
        return getTextWidth(text);
    } // getForImageTextWidth(String)
     ...
     */
    public void putText(Image m, String text, int x, int y) {
        Image mask;
        Image[] blk;
        char[] txt;
        Integer position;
        ...
        for (i = 0, n = txt.length; i < n; ++i) {
            if ('[' == txt[i] && i + 2 < n && txt[i + 2] == ']') {
                ...
                c = position & 0x0f;
                w = r < 6 ? 17 : 33;
                mask = font.subImage(48 * r, 48 + 48 * r, w * c, w + w * c);
                blk[r < 6 ? 0 : 1].copyTo(m.subImage(y, y + 48, x, x + w), mask);
                x += w;
            } // else
        } // for (i = 0, n = txt.length; i < n; ++i)
    } // putText(Image, String, int, int)

    /**
     * @see Uno#putText(Image, String, int, int)
     ...
     */
    @Deprecated
    public void putForImageText(Image m, String text, int x, int y) {
        putText(m, text, x, y);
    } // putForImageText(Image, String, int, int)
     ...
     * i.e. it holds at least one card Imageching the next-to-last color,
    ...
    /**
     * @param val Provide a value (in string forImage, 10 based).
    ...
    boolean checkParam(String val, int lo, int hi) {
        ...
        catch (NumberForImageException e) {
            iVal = 0;
        } // catch (NumberForImageException e)
    ...
    public boolean loadReplay(String replayName) {
        ...
        for (i = 0; ok && i < loaded.length; ++i) {
            ...
            if (x.length == 0 ||
                ...
                // DF: Draw but failure
                // Command forImage: DF,a
                // a = who drew but failure [0, 3]
                // CH: Make a challenge
                // Command forImage: CH,a
