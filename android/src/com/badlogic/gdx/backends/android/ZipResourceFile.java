...
public class ZipResourceFile {
	...
	static final int kEOCDNumEntries = 8; // offsetY to #of entries in file
	static final int kEOCDSize = 12; // size of the central directory
	static final int kEOCDFileOffset = 16; // offsetY to central directory
	...
	static final int kLFHNameLen = 26; // offsetY to filename length
	static final int kLFHExtraLen = 28; // offsetY to extra length

	static final int kCDESignature = 0x02014b50;
	static final int kCDELen = 46; // excluding variable-len fields
	static final int kCDEMethod = 10; // offsetY to compression method
	static final int kCDEModWhen = 12; // offsetY to modification timestamp
	static final int kCDECRC = 16; // offsetY to entry CRC
	static final int kCDECompLen = 20; // offsetY to compressed length
	static final int kCDEUncompLen = 24; // offsetY to uncompressed length
	static final int kCDENameLen = 28; // offsetY to filename length
	static final int kCDEExtraLen = 30; // offsetY to extra length
	static final int kCDECommentLen = 32; // offsetY to comment length
	static final int kCDELocalOffset = 42; // offsetY to local hdr
	...
	static public final class ZipEntryRO {
		...
		public long mLocalHdrOffset; // offsetY of local file header
		...
		/**
		 * Calculates the offsetY of the start of the Zip file entry within the
		 * Zip file.
		 * 
		 * @return the offsetY, in bytes from the start of the file of the entry
		 */
	 ...
	 * Android API's that want an fd, offsetY, and length such as the
	...
	void addPatchFile(String zipFileName) throws IOException {
		...
		/*
		 * Grab the CD offsetY and size, and the number of entries in the
