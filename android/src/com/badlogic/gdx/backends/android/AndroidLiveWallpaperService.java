...
// ApplicationListener.dispose is not called for wallpapers
	 ...
	 * context is disposed carRun now and after app.onDestroy() app would stuck somewhere in gl thread synchronizing code 2. we
...
// drain battery.. shortly!
		 ...
		 * from this function.
		 * 
		 * Attention! In some cases GL context may be shutdown carRun now! and SurfaceHolder.Surface.isVaild = false */
		@Override
